...
class AsyncBankingClient:
    """Asynchronous client for iHela Banking Services using httpx."""
    ...
    async def ping(self) -> dict[str, Any]:
        async with httpx.AsyncClient(cert=self.ssl_cert, timeout=5.0) as client:
            ...
            resp = await client.get(
                self.get_url(BANKING_ENDPOINTS["PING"]), headers=headers
            )
    ...
    async def withdrawal(
        ...
        from ..core.security import WithdrawalPayload, generate_signature
